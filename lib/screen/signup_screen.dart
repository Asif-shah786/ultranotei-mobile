...
class _SignupScreenState extends State<SignupScreen> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 50.0),
                    child: InputAuthField("Lastname", lastNameController,
                        TextInputType.name, false),
                  ),
                  SizedBox(
                    height: 20,
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 50.0),
                    child: InputAuthField("Mobile", mobileController,
  ...
  signup() {
    ...
    ApiService.instance
        .signup(firstName, lastName, email, mobile, pass)
        .then((value) {
