...
class _SendScreenState extends State<SendScreen>
    with AutomaticKeepAliveClientMixin<SendScreen> {
  @override
    ...
    return ModalProgressHUD(
      ...
      child: Column(
        children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InputAmountField("Enter amount", amountController,
                        TextInputType.numberWithOptions(decimal: true), false),
                    SizedBox(
                      height: 5,
                    ),
                    Text(
                      "Amount in bits, Ex: 1000000 = 1 XUNI coin",
                      style: CustomAppTheme.smallWhiteText,
                    ),
                    SizedBox(
                      height: 20,
                    ...
                    InputAddressField("Enter note", noteController,
          ...
          MyWalletCard(
              '${(double.parse(widget.BALANCE)).toStringAsFixed(6)} XUNI',
              '0.0'),
        ],
      ),
    );
  ...
  onSend() {
    ...
    cUSer.then((cvalue) {
      ...
      ApiService.instance
          .withdraw(cvalue.id, widget.ADDRESS, recepientAddress, amount, note,
              paymentId)
          .then((value) {
        setState(() {
        ...
        if (value.statusCode == 200) {
          print('transactionValue${extractData.toString()}');
          print('transactionValue${value.toString()}');
